          ...
          <div className="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
            ...
            <div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                ...
                {/* Facebook */}
                <button
                  className="flex w-full items-center border border-gray-300 justify-center gap-3 rounded-md bg-[#1877F2] px-3 py-1.5 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1877F2]"
